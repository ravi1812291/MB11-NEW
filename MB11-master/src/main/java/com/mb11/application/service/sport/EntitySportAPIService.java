...
public class EntitySportAPIService {
	 ...
	 */
	public List<Series> getSeries(String year) throws JSONException {
	...
	public Set<MTeam> getTeams(Series series) throws JSONException {
	 ...
	 * @throws ParseException the parse exception
	 */
	public List<Match> getMatches(String seriesId) throws JSONException {
	 ...
	 */
	public List<TeamPlayers> getTeamPlayers(String seriesId) throws JSONException {
